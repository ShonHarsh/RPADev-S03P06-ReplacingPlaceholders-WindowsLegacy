...
**GitHub:** https://github.com/ShonHarsh/RPADev-S03P06-ReplacingPlaceholders-WindowsLegacy
...
```sh
git clone https://github.com/ShonHarsh/RPADev-S03P06-ReplacingPlaceholders-WindowsLegacy
```
